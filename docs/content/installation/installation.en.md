...
```sh
$ helm install --namespace fission --set serviceType=NodePort,routerServiceType=NodePort https://github.com/fission/fission/releases/download/0.9.0/fission-all-0.9.0.tgz
```
...
```sh
$ helm install --namespace fission https://github.com/fission/fission/releases/download/0.9.0/fission-all-0.9.0.tgz
```
...
```sh
$ helm install --namespace fission https://github.com/fission/fission/releases/download/0.9.0/fission-core-0.9.0.tgz
```
...
```sh
$ curl -Lo fission https://github.com/fission/fission/releases/download/0.9.0/fission-cli-osx && chmod +x fission && sudo mv fission /usr/local/bin/
```

#### Linux

```sh
$ curl -Lo fission https://github.com/fission/fission/releases/download/0.9.0/fission-cli-linux && chmod +x fission && sudo mv fission /usr/local/bin/
```

#### Windows

For Windows, you can use the linux binary on WSL. Or you can download
this windows executable: [fission.exe](https://github.com/fission/fission/releases/download/0.9.0/fission-cli-windows.exe)
...
```sh
$ fission env create --name nodejs --image fission/node-env:0.9.0
...
```sh
$ fission env create --name go --image fission/go-env:0.9.0 --builder fission/go-builder:0.9.0
