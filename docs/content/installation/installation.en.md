...
```sh
$ helm install --namespace fission https://github.com/fission/fission/releases/download/0.7.1/fission-all-0.7.1.tgz
```
...
this windows executable: [fission.exe](https://github.com/fission/fission/releases/download/0.7.1/fission-cli-windows.exe)
...
```sh
$ fission env create --name nodejs --image fission/node-env:0.7.1
...
```sh
$ fission env create --name go --image fission/go-env:0.7.1 --builder fission/go-builder:0.7.1
