...
```sh
$ helm install --name fission --namespace fission https://github.com/fission/fission/releases/download/1.2.1/fission-core-1.2.1.tgz
```
...
$ kubectl apply -f https://github.com/fission/fission/releases/download/1.2.1/fission-core-1.2.1-minikube.yaml
```
...
```sh
$ fission env create --name go --image fission/go-env:1.2.1 --builder fission/go-builder:1.2.1
