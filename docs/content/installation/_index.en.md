...
```sh
$ helm install --name fission --namespace fission --set serviceType=NodePort,routerServiceType=NodePort https://github.com/fission/fission/releases/download/1.4.0/fission-all-1.4.0.tgz
```
...
```sh
$ helm install --name fission --namespace fission https://github.com/fission/fission/releases/download/1.4.0/fission-core-1.4.0.tgz
```
...
$ kubectl apply -f https://github.com/fission/fission/releases/download/1.4.0/fission-core-1.4.0.yaml

# Minimal install on minikube:
$ kubectl apply -f https://github.com/fission/fission/releases/download/1.4.0/fission-core-1.4.0-minikube.yaml
```
...
```sh
$ fission env create --name go --image fission/go-env:1.4.0 --builder fission/go-builder:1.4.0
